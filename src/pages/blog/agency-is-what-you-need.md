...
title: 'Agency Is What You Need Now'
description: "In a world where AI makes everything easier, the only unfair advantage left is your ability to act. Intelligence is commoditized. Execution isn't."
pubDate: 'December 30, 2025'
heroImage: /covers/agency-is-what-you-need.png
---

I wrote recently about how [AI will take your job](/blog/ai-will-take-your-job), and the economic reality staring us in the face. But here's the flip side that keeps me up at night:
...
And what Robert Greene describes in [The 48 Laws of Power](https://a.co/d/78xHkJl) as the Law of Boldness:
...
Paul Graham [captures this perfectly](https://paulgraham.com/startupideas.html):
...
- When I needed a better JavaScript stack for building products, I didn't complain about the complexity of modern web development—[I built The Boring JavaScript Stack](https://docs.sailscasts.com/boring-stack) with [Mellow](https://docs.sailscasts.com/boring-stack/mellow) and [Ascent](https://docs.sailscasts.com/boring-stack/ascent) templates.

![The Boring JavaScript Stack](/post-images/boring-stack.png)
...
As I wrote in my [AI will take your job piece](/blog/ai-will-take-your-job):
...
I've studied people who get stuff done. People like Taylor Otwell, DHH, Jason Fried, Caleb Porzio, Mike McNeil. [My role models](/blog/mentor-not-required).
...
When I launched [guppy](/blog/launching-guppy), it wasn't perfect. When I rolled out The Boring Stack templates, they were version 0.1. When I took over as lead maintainer of Sails.js, I didn't have all the answers.
...
As I wrote in [Shut Up and Act](/blog/shut-up-act):
...
When Sails needed better documentation, I didn't wait for someone to ask me to write it. I [wrote guides](https://blog.sailscasts.com).

When the community needed a place to gather, I [opened the doors](https://sailscasts.com/chat).

When African engineers needed representation, I [started publishing](https://africanengineer.com/issues).
...
As I shared in [my open-source journey](/blog/my-open-source-journey):
...
Not what you plan. What you ship.
Not what you could build. What you actually built.

Robert Greene writes in [The 48 Laws of Power](https://a.co/d/78xHkJl):
...
What's your take on agency in the age of AI? Let me know on [X](https://x.com/dominus_kelvin).
